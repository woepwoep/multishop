<?php
	...
	foreach ($products as $product)
	{
		...
		$link=mslib_fe::typolink($this->shop_pid,'&'.$where.'&products_id='.$product['products_id'].'&tx_multishop_pi1[page_section]=products_detail&skeywords='.urlencode($this->get['q']));
